...
driver.find_element(By.XPATH,"//input[@aria-label='搜尋此社團']").send_keys(goods) #將關鍵字放進搜尋欄
time.sleep(2)
driver.find_element(By.XPATH,"//input[@aria-label='搜尋此社團']").send_keys(
Keys.ENTER)
time.sleep(8)
